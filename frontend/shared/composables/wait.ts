...
export enum Wait {
  ...
  MARKETPLACE_CREATE,
  MARKETPLACE_UPDATE,
  MARKETPLACE_INTEGRATIONS_FETCH,
  MARKETPLACE_TELEGRAM_BOT_FETCH,
  MARKETPLACE_TELEGRAM_BOT_CREATE,
  MARKETPLACE_TELEGRAM_BOT_UPDATE,
  MARKETPLACE_TELEGRAM_BOT_DELETE,
  MARKETPLACE_ORDERS_FETCH,
  MARKETPLACE_ORDER_UPDATE,
  MARKETPLACE_PAYLOAD_FETCH,
  MARKETPLACE_TELEGRAM_BOT_CUSTOMERS_FETCH,
}
