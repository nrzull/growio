...
export enum Wait {
  ...
  MARKETPLACE_CREATE,
  MARKETPLACE_UPDATE,
  MARKETPLACE_WAREHOUSES_FETCH,
  MARKETPLACE_WAREHOUSE_CREATE,
  MARKETPLACE_WAREHOUSE_UPDATE,
  MARKETPLACE_WAREHOUSE_DELETE,
  MARKETPLACE_WAREHOUSE_ITEMS_FETCH,
  MARKETPLACE_WAREHOUSE_ITEM_CREATE,
  MARKETPLACE_WAREHOUSE_ITEM_UPDATE,
  MARKETPLACE_WAREHOUSE_ITEM_DELETE,
}
